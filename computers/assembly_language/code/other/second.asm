...
; First, we include useful definitions for our hardware (names of pins, ports, etc.)
.nolist
...
; - If we repeat this counting, say 61 times, we get approx. 1 secon
...
delay:							; Delay sub-routine: delay for some number of clock cycles
	...
	outer_loop:
	LDI	r24, low(0)				; Load an offset number in r24 (lower byte)
	LDI	r25, high(0)			; Load an offset number in r25 (upper byte)
